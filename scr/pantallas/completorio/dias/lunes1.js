...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>LUNES PRIMERA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.lunes1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.lunes1.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.lunes1.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.lunes1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.lunes1.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.lunes1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.lunes1.cuerpo}</Text>
...
export default function Lunes1() {
  return (
    <Stack1.Navigator>
