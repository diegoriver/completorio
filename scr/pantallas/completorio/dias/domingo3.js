...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>DOMINGO TERCERA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.domingo3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.domingo3.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.domingo3.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.domingo3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.domingo3.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.domingo3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.domingo3.cuerpo}</Text>
