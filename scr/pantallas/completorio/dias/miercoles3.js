...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>MIERCOLES TERCERA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.miercoles3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.miercoles3.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.miercoles3.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.miercoles3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.miercoles3.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.miercoles3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.miercoles3.cuerpo}</Text>
