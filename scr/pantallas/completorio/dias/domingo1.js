...
// se importa el header para cambiar tamañp de fuente desde tabHeader.js
import Fuente from '../../../componentes/tabHeader';

// se importan los styles desde varible.js
...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Fuente />
      <Text style={variable.styles.titulodia}>DOMINGO PRIMERA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.domingo1.nombre}</Text>
...
export default function Martes1() {
  return (
    <Stack1.Navigator  mode="modal" headerMode= "none" > 
