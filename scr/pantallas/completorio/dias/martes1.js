...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>MARTES PRIMERA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.martes1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.martes1.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.martes1.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.martes1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.martes1.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.martes1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.martes1.cuerpo}</Text>
