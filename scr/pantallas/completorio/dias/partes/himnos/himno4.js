...
export default function Himno4() {
  return (
    <ScrollView style={variable.styles.container}>
      <Text></Text>
      <Text style={variable.styles.nombre}>{HimnosIniciales.himno4.nombre}</Text>
      <Image style={variable.styles.imageHim4} source={require('../imagescompletorio/diaynoche.png')} />
      <Text style={variable.styles.cuerpo}>{HimnosIniciales.himno4.cuerpo}</Text>
      <Text> </Text>
      <Text> </Text>
    </ScrollView>
  );
