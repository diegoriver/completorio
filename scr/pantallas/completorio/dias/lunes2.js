...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>LUNES SEGUNDA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.lunes2.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.lunes2.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.lunes2.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.lunes2.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.lunes2.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.lunes2.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.lunes2.cuerpo}</Text>
...
export default function Lunes2() {
  return (
    <Stack1.Navigator>
