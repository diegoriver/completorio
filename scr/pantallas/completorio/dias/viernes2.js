...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>VIERNES SEGUNDA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.viernes2.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.viernes2.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.viernes2.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Final.viernes.nombre}</Text>
      <Text style={variable.styles.titulo}>{Final.viernes.titulo}</Text>
      <Text style={variable.styles.cuerpo}>{Final.viernes.cuerpo}</Text>
      <Text></Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.viernes2.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.viernes2.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.viernes2.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.viernes2.cuerpo}</Text>

      <Text></Text>
      <SalmoDifuntos />

      <Text style={variable.styles.nombre}>{Difuntos.viernes.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Difuntos.viernes.cuerpo}</Text>
