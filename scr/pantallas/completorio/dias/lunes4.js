...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>LUNES CUARTA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.lunes4.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.lunes4.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.lunes4.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.lunes4.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.lunes4.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.lunes4.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.lunes4.cuerpo}</Text>
...
export default function Lunes4() {
  return (
    <Stack1.Navigator>
