...
function CompletasScreen({ navigation }) {
  ...
  ///////// AQUI SE PONEN LOS DATROS QUE VIENE DE DRAWER///////////////
  const diatitulo = "DOMINGO PRIMERA SEMANA";
  const diasalmo = "<Salmodomingo />"; // no funciona
  const lecturas = "Lectura.domingo1.nombre";
  ...
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>{diatitulo}</Text>
      <Text></Text>
      <InvocacioInicial />
      
      <Text></Text>
      <Text style={variable.styles.nombre}>EXAMEN DE CONCIENCIA</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Formulario1')}>Formulario 1</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Formulario2')}>Formulario 2</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Formulario3')}>Formulario 3</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Formulario4')}>Formulario 4</Text>      <Text></Text>      
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Formulario5')}>Formulario 5</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Formulario6')}>Formulario 6</Text>      <Text></Text>
      
      <Text></Text>
      <Text style={variable.styles.nombre}>HIMNOS</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Himno1')}>QUE VES EN LA NOCHE</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Himno2')}>SOL DE MI SER</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Himno3')}>CERCA DE TI, SEÑOR</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Himno4')}>DÍA Y NOCHE</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Himno5')}>JUNTO A TI, SEÑOR</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Himno6')}>QUÉDATE CON NOSOTROS</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Himno7')}>PORQUE ANOCHECE YA</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Himno8')}>BENDITO SILENCIO</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Himno9')}>LA NOCHE</Text>      <Text></Text>
      ...
      <Text></Text>
      ///////////////////////////////////////////////////////////////////
      <Text style={variable.styles.nombre}>{lecturas}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.domingo1.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.domingo1.cita}</Text>
      ///////////////////////////////////////////////////////////////////

      <Text></Text>
      <Text style={variable.styles.nombre}>RESPONSORIO BREVE</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Responsorio1')}>FERIAS</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Responsorio2')}>SÁBADOS Y DOMINGOS</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Responsorio3')}>MEMORIAS Y FIESTAS</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Responsorio4')}>SOLEMNIDADES Y TIEMPO DE PASCUA</Text>

      <Text></Text>
      <Text style={variable.styles.nombre}>CANTICO EVANGÉLICO</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Cantico1')}>FERIAS</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Cantico2')}>SÁBADOS Y DOMINGOS</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Cantico3')}>MEMORIAS</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('Cantico4')}>FIESTAS, SOLEMNIDADES Y TIEMPO DE PASCUA</Text>      <Text></Text>

      ///////////////////////////////////////////////////////////////////
      <Text style={variable.styles.nombre}>{Final.domingo.nombre}</Text>
      <Text style={variable.styles.titulo}>{Final.domingo.titulo}</Text>
      <Text style={variable.styles.cuerpo}>{Final.domingo.cuerpo}</Text>
      ///////////////////////////////////////////////////////////////////
      <Text></Text>
      ...
      <Text></Text>
      <Text></Text>
      <Text style={variable.styles.nombre}>SALVE</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('SALVE - forma larga')}>SALVE - forma larga</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('SALVE - forma breve')}>SALVE - forma breve</Text>      <Text></Text>

      
      ///////////////////////////////////////////////////////////////////
      <Text style={variable.styles.nombre}>{Salve.domingo1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.domingo1.cuerpo}</Text>
      ///////////////////////////////////////////////////////////////////
      
      
      <Text></Text>
      <Text></Text>
      <Text style={variable.styles.nombre}>CANTO A SANTO DOMINGO</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('O SPEM MIRAM - forma larga')}>O SPEM MIRAM - forma larga</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('O SPEM MIRAM - forma breve')}>O SPEM MIRAM - forma breve</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('OH ESPERANZA')}>OH ESPERANZA</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('OH LUMEN')}>OH LUMEN</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('OH LUZ DE LA IGLESIA - forma larga')}>OH LUZ DE LA IGLESIA - forma larga</Text>      <Text></Text>
      <Text style={variable.styles.enlace} onPress={() => navigation.navigate('OH LUZ DE LA IGLESIA - forma breve')}>OH LUZ DE LA IGLESIA - forma breve</Text>      <Text></Text>


      
      ///////////////////////////////////////////////////////////////////
      <Text style={variable.styles.nombre}>{StoDomingo.domingo1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.domingo1.cuerpo}</Text>
      ///////////////////////////////////////////////////////////////////
      <Text></Text>
      <SalmoDifuntos />
      ///////////////////////////////////////////////////////////////////
      <Text style={variable.styles.nombre}>{Difuntos.domingo.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Difuntos.domingo.cuerpo}</Text>
      ///////////////////////////////////////////////////////////////////
      <Text></Text>
      <Text></Text>
    </ScrollView>
