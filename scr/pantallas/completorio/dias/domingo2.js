...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>DOMINGO SEGUNDA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.domingo2.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.domingo2.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.domingo2.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.domingo2.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.domingo2.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.domingo2.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.domingo2.cuerpo}</Text>
...
export default function Martes1() {
  return (
    <Stack1.Navigator>
      ...
      <Stack1.Screen name="O SPEM MIRAM - forma larga" component={StoDomingo2} />
