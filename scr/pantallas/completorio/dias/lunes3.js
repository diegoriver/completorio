...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>LUNES TERCERA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.lunes3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.lunes3.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.lunes3.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Final.lunes.nombre}</Text>
      <Text style={variable.styles.titulo}>{Final.lunes.titulo}</Text>
      <Text style={variable.styles.cuerpo}>{Final.lunes.cuerpo}</Text>
      <Text></Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.lunes3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.lunes3.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.lunes3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.lunes3.cuerpo}</Text>

      <Text></Text>
      <SalmoDifuntos />

      <Text style={variable.styles.nombre}>{Difuntos.lunes.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Difuntos.lunes.cuerpo}</Text>
...
export default function Lunes3() {
  return (
    <Stack1.Navigator>
