...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>MARTES TERCERA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.martes3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.martes3.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.martes3.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Final.martes.nombre}</Text>
      <Text style={variable.styles.titulo}>{Final.martes.titulo}</Text>
      <Text style={variable.styles.cuerpo}>{Final.martes.cuerpo}</Text>
      <Text></Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.martes3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.martes3.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.martes3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.martes3.cuerpo}</Text>

      <Text></Text>
      <SalmoDifuntos />

      <Text style={variable.styles.nombre}>{Difuntos.martes.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Difuntos.martes.cuerpo}</Text>
