...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>SÁBADO TERCERA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.sabado3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.sabado3.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.sabado3.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Final.sabado.nombre}</Text>
      <Text style={variable.styles.titulo}>{Final.sabado.titulo}</Text>
      <Text style={variable.styles.cuerpo}>{Final.sabado.cuerpo}</Text>
      <Text></Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.sabado3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.sabado3.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.sabado3.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.sabado3.cuerpo}</Text>

      <Text></Text>
      <SalmoDifuntos />

      <Text style={variable.styles.nombre}>{Difuntos.sabado.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Difuntos.sabado.cuerpo}</Text>
