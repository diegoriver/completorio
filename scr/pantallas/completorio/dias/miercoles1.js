...
import SalmoDifuntos from './partes/salmodifuntosmiercoles';
...
function CompletasScreen({ navigation }) {
  return (
    <ScrollView style={variable.styles.container}>
      <Text style={variable.styles.titulodia}>MIERCOLES PRIMERA SEMANA</Text>
      <Text></Text>
      <InvocacioInicial />
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Lectura.miercoles1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Lectura.miercoles1.cuerpo}</Text>
      <Text style={variable.styles.cita}>{Lectura.miercoles1.cita}</Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Final.miercoles.nombre}</Text>
      <Text style={variable.styles.titulo}>{Final.miercoles.titulo}</Text>
      <Text style={variable.styles.cuerpo}>{Final.miercoles.cuerpo}</Text>
      <Text></Text>
      ...
      <Text></Text>
      <Text style={variable.styles.nombre}>{Salve.miercoles1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Salve.miercoles1.cuerpo}</Text>
      ...
      <Text style={variable.styles.nombre}>{StoDomingo.miercoles1.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{StoDomingo.miercoles1.cuerpo}</Text>

      <Text></Text>
      <SalmoDifuntos />

      <Text style={variable.styles.nombre}>{Difuntos.miercoles.nombre}</Text>
      <Text style={variable.styles.cuerpo}>{Difuntos.miercoles.cuerpo}</Text>
